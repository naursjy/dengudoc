...
<section id="hero" class="d-flex align-items-center">
    <div class="container">
        <h2 style="font-size: 42px;">Selamat datang di <b>DenguDoc</b></h2>
            ...
            <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="content">
                        <h3>Apa itu DBD?</h3>
                        <p>
                            Demam berdarah atau DBD adalah penyakit yang menular melalui nyamuk yang terjadi di daerah
                            tropis dan subtropis di dunia. Gejala DBD yang umum adalah demam tinggi dan gejala seperti
                            flu.
                        </p>
                        <div class="text-center">
                            <a href="#" class="more-btn">Mulai<i class="bx bx-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <h4>Gejala demam berdarah klasik</h4>
                                    <p>Gejala dari demam berdarah klasik biasanya diawali dengan demam selama 4 hingga 7
                                        hari setelah digigit oleh nyamuk yang terinfeksi</p>
                                </div>
                            </div>
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    <i class="bx bx-cube-alt"></i>
                                    <h4>Gejala dengue hemorrhagic fever</h4>
                                    <p>Gejala dari dengue hemorrhagic fever meliputi semua gejala dari demam berdarah
                                        klasik</p>
                                </div>
                            </div>
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <h4>Gejala dengue shock syndrome</h4>
                                    <p>Gejala dari dengue shock syndrome, jenis penyakit dengue yang paling parah,
                                        meliputi semua gejala demam berdarah klasik dan dengue hemorrhagic fever
                                    </p>
                                </div>
                            </div>
                        </div>
