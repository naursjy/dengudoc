<body>
  ...
  if ($id != "") {
    $sql1 = "select * from konten_musik where id = '$id'";
  ...
  if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
      ...
      if ($id != "") {
        $sql1 = "update konten_musik set judul = '$judul', tanggal='$tanggal', deskripsi_pendek='$deskripsi_pendek',deskripsi='$deskripsi', foto='$foto_name' where id = '$id'";
      } else {
        $sql1 = "insert into  konten_musik (judul,tanggal,deskripsi_pendek,deskripsi,foto) values ('$judul','$tanggal','$deskripsi_pendek','$deskripsi','$foto_name')";
      }
    ...
    <section class="section">
      ...
      <div class="row">
        <div class="col-lg">
          <div class="card pt-3">
            <div class="card-body">
              <h5 class="card-title">Form Mengganti Tampilan Konten Musik</h5>
              <?php
              if ($error) {
                ?>
