<body>
    ...
    if (isset($_POST['simpan'])) {
        ...
        if (empty($error)) {
            ...
            if ($id != "") {
                $sql1 = "update tutors set nama = '$nama',foto='$foto_name' where id = '$id'";
            } else {
                $sql1 = "insert into  tutors (nama,foto) values ('$nama','$foto_name')";
            }
    ...
    <main id="main" class="main">
        <section class="section">
            <div class="pagetitle">
                <h1>Mengganti Slide Show Gambar</h1>
                <nav>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-lg">
                    <div class="card pt-3">
                        <div class="card-body">
                            <h5 class="card-title">Form Mengganti Slide Show Gambar</h5>
                            <?php
                            if ($error) {
                                ?>
