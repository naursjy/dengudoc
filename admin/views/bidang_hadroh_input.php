<body>
  ...
  if ($id != "") {
    $sql1 = "select * from konten_hadroh where id = '$id'";
    ...
    if ($judul == '' or $deskripsi_pendek == '' or $deskripsi == '' or $foto == '') {
  ...
  if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
      if ($foto_name) {
        ...
        $foto_name = "bidang_musik_" . time() . "_" . $foto_name;
      ...
      if ($id != "") {
        $sql1 = "update konten_hadroh set judul = '$judul', tanggal='$tanggal', deskripsi_pendek='$deskripsi_pendek',deskripsi='$deskripsi', foto='$foto_name' where id = '$id'";
      } else {
        $sql1 = "insert into  konten_hadroh (judul,tanggal,deskripsi_pendek,deskripsi,foto) values ('$judul','$tanggal','$deskripsi_pendek','$deskripsi','$foto_name')";
      }
    ...
    <section class="section">
      ...
      <div class="row">
        <div class="col-lg">
          <div class="card pt-3">
            <div class="card-body">
              <h5 class="card-title">Form Mengganti Tampilan Konten Hadroh</h5>
              <?php
              if ($error) {
                ?>
