<body>
    ...
    if ($op == 'delete') {
        $id = $_GET['id'];
        $sql1 = "select foto from konten_teater where id = '$id'";
        $q1 = mysqli_query($koneksi, $sql1);
        $r1 = mysqli_fetch_array($q1);
        @unlink("../images/" . $r1['foto']);

        $sql1 = "delete from konten_teater where id = '$id'";
        $q1 = mysqli_query($koneksi, $sql1);
        if ($q1) {
                ...
                <div class="col-lg">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="bidang_teater_input.php">
                            ...
                            <form class="row g-3 mt-1" method="get">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $sql1 = "select * from konten_teater $sqltambahan";
                                        ...
                                        while ($r1 = mysqli_fetch_array($q1)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="../images/<?php echo foto_konten_teater($r1['id']) ?>"
                                                ...
                                                <td>
                                                    <a href="bidang_teater_input.php?id=<?php echo $r1['id'] ?>">
                                                        <span class="badge bg-warning text-dark">Edit</span>
                                                    </a>

                                                    <a href="bidang_teater.php?op=delete&id=<?php echo $r1['id'] ?>"
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        ...
                                        for ($i = 1; $i <= $pages; $i++) {
                                            ...
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="bidang_teater.php?katakunci=<?php echo $katakunci ?>&cari=<?php echo $cari ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
                                            </li>
                                            <?php
                                        }
                                        ?>
