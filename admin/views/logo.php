<body>
    ...
    if ($op == 'delete') {
        $id = $_GET['id'];
        $sql1 = "select foto from logo where id = '$id'";
        $q1 = mysqli_query($koneksi, $sql1);
        $r1 = mysqli_fetch_array($q1);
        @unlink("../images/" . $r1['foto']);

        $sql1 = "delete from logo where id = '$id'";
        $q1 = mysqli_query($koneksi, $sql1);
        if ($q1) {
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql1 = "select * from logo $sqltambahan";
                                    ...
                                    while ($r1 = mysqli_fetch_array($q1)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../images/<?php echo logo_foto($r1['id']) ?>"
                                                    style="max-height:100px;max-width:100px" /></td>
                                            <td>
                                                <a href="logo_input.php?id=<?php echo $r1['id'] ?>">
