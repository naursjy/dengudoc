<body>
  ...
  if ($id != "") {
    $sql1 = "select * from konten_tari where id = '$id'";
    ...
    if ($judul == '' or $tanggal == '' or $deskripsi_pendek == '' or $deskripsi == '' or $foto == '') {
  ...
  if (isset($_POST['simpan'])) {
    ...
    if ($judul == '' or $tanggal == '' or $deskripsi_pendek == '' or $deskripsi == '') {
    ...
    if (empty($error)) {
      if ($foto_name) {
        ...
        $foto_name = "bidang_tari_" . time() . "_" . $foto_name;
      ...
      if ($id != "") {
        $sql1 = "update konten_tari set judul = '$judul', tanggal='$tanggal', deskripsi_pendek='$deskripsi_pendek',deskripsi='$deskripsi', foto='$foto_name' where id = '$id'";
      } else {
        $sql1 = "insert into  konten_tari (judul,tanggal,deskripsi_pendek,deskripsi,foto) values ('$judul','$tanggal','$deskripsi_pendek','$deskripsi','$foto_name')";
      }
        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-lg">
                    <div class="card pt-3">
                        <div class="card-body">
                            <h5 class="card-title">Form Mengganti Tampilan Konten Tari</h5>
                            <?php
              if ($error) {
                ?>
              ...
              ?>
                    ...
                    ?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10"> <textarea type="text" class="form-control"
                                            id="deskripsi_pendek" name="deskripsi_pendek">
                <?php echo $deskripsi_pendek ?></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
