...
<body>
    ...
    <aside id="sidebar" class="sidebar ">
        ...
        <ul class="sidebar-nav " id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../views/tentang_kami.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../views/ganti_password.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../views/pendaftaran.php">
